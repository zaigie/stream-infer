...
import time
import threading
from typing import List, Any, Literal, Dict, Optional, Deque, Union, TypeVar
    ...
    def get_frames(self, count: int, step: int) -> List[Any]:
        ...
        with self._lock:
            ...
            if step == 0:
                ...
                indices = range(queue_len - 1, max(-1, queue_len - count * step - 1), -step)
...
class DispatcherManager:
    ...
    def _initialize_manager(self, buffer: int, logging_level: str = "INFO", **kwargs) -> None:
        """
        初始化进程管理器
